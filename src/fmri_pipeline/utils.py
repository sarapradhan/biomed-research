"""Shared utility functions for logging, reproducibility, path management, and serialization.

Provides deterministic seeding, timestamped file/console logging,
standardized output path construction following BIDS naming conventions,
JSON serialization, and upper-triangle matrix extraction helpers.
"""
