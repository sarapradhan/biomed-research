"""Visualization utilities for connectivity matrices, brain maps, and group comparisons.

Provides plotting functions for thresholded connectivity difference matrices,
boxplots stratified by diagnostic group, orthogonal brain stat-map views,
and NIfTI volume reconstruction from masked vectors.
"""
